    ...
    <article className="relative flex overflow-hidden shadow-neon rounded-xl">
      <div className="max-w-48">
        <img
          ...
          className="object-cover h-auto w-28 md:w-full"
        />
      </div>
      <div className="flex flex-col flex-1">
        <h2 className="mt-2 font-bold text-md md:text-xl line-clamp-1">
          {title}
        </h2>
        {release_date && (
        ...
        />
        <p className="mx-2 mt-5 text-sm md:text-lg text-start md:mx-3 line-clamp-3 md:line-clamp-6">
          {overview}
        </p>
      </div>
    </article>
